 ...
 * 
 * DESCRIPTION:
 *   1. IMU Motion Classifier & Fall Detector (50 Hz sliding window, Acc: 100.0%)
...
inline int predictTinyMLClass(float f_mean_mag, float f_min_mag, float f_max_mag, float f_std_mag, float f_max_gyro, float f_tilt_delta, float f_still_var, float &out_prob) {
...
inline int predictTinyMLHeatwaveClass(float temp_c, float humidity, float heat_index_c, float heart_rate, float spo2, float &out_prob) {
